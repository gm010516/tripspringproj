...
<title>TRIPLIST_SPOTLISTUSER</title>
<style>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarColor03">
				<ul class="navbar-nav me-auto">
					...
					<!-- <li class="nav-item"><a class="nav-link" href="getTravelSpotListuser.do">TravelList</a></li> -->
				...
				<tr>
					<td><span style="text-align: center; font-family: serif;">
							<c:forEach items="${top3}" var="travel">
								<a href="getTravelSpotuser.do?seq=${travel.seq}"
					...
					<div align="center" style="position: relative;">
						...
						<script>
							...
							function panTo0() { //전체보기
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}";
							...
							function panTo1() { //경기도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=경기";
								/* var moveLatLon = new kakao.maps.LatLng(37.567167,
										127.190292);
								var level = map.getLevel();
								map.setLevel(level = 11);
							...
							function panTo2() { //강원도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=강원";
							...
							function panTo3() { //충청남도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=충남";
							...
							function panTo4() { //충청북도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=충북";
							...
							function panTo5() { //경상북도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=경북";
							...
							function panTo6() { //경상남도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=경남";
							...
							function panTo7() { //전라북도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=전북";
							...
							function panTo8() { //전라남도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=전남";
							...
							function panTo9() { //제주특별자치도
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=제주";
							...
							function panTo11() { //서울특별시
								window.location.href = "getTravelSpotListuser.do?nowPage=1&cntPerPage=${paging.cntPerPage}&searchCondition=ADDRESS&searchKeyword=서울";
			...
			<td>
				<table class="table table-hover" align="center">
					<tbody>
						...
						<div align="left">
							<form method="get" action="getTravelSpotListuser.do">
						...
						<c:forEach items="${travelList}" var="travel">
							...
							<form action="insertBookmark.do" method="post">
								...
								<input type="hidden" name="seq" value="${travel.seq}"> <input
												...
												<table>
													...
													<tr>
														<td colspan="2" align="left"><input type="submit"
															value="즐겨찾기 추가" class="b" id="bookMark"></td>
														<c:if
															test="${ checkMark == 1 && checkseq == 1 && checkMark == checkseq && checkseq == travel.seq}">
															<script>
																alert("즐겨찾기에 이미 등록되었습니다. 다른 여행지를 추가해보세요!");
															</script>
			...
			<ul class="pagination">
				<c:if test="${paging.startPage != 1 }">
					<li class="page-item"><a class="page-link"
						href="getTravelSpotListuser.do?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}&searchCondition=${paging.searchCondition }&searchKeyword=${paging.searchKeyword}">&lt;</a>
					</li>
				</c:if>
				...
				<c:forEach begin="${paging.startPage }" end="${paging.endPage }"
					...
					<c:choose>
						...
						<c:when test="${p != paging.nowPage }">
							<li class="page-item"><a class="page-link"
								href="getTravelSpotListuser.do?nowPage=${p }&cntPerPage=${paging.cntPerPage}&searchCondition=${paging.searchCondition }&searchKeyword=${paging.searchKeyword}">${p}</a>
							</li>
						</c:when>
					</c:choose>
				</c:forEach>
				...
				<c:if test="${paging.endPage != paging.lastPage}">
					<li class="page-item"><a class="page-link"
						href="getTravelSpotListuser.do?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}&searchCondition=${paging.searchCondition }&searchKeyword=${paging.searchKeyword}">&gt;</a>
					</li>
				</c:if>
			</ul>
		</div>
