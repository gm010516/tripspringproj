...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
		...
		<div class="container-fluid">
			<a class="navbar-brand" href="memberInfo.me">TRIP</a> <span
				class="nav-link active">${user.MEMBER_ID }님</span>
		...
		<article class="wrapper">
			<div class="marquee">
				<div class="marquee__group">
					<svg>
                  <image
							href="${pageContext.request.contextPath}/boardUpload/admin/우도1.jpg"
							style="height:200px;" />
               </svg>
					<svg>
                  <image
							href="${pageContext.request.contextPath}/boardUpload/admin/캐리비안베이1.jpg"
							style="height:200px;" />
               </svg>
					<svg>
                  <image
							href="${pageContext.request.contextPath}/boardUpload/admin/에버랜드1.jpg"
							style="height:200px;" />
               </svg>
					<svg>
                  <image
							href="${pageContext.request.contextPath}/boardUpload/admin/한라산1.jpg"
							style="height:200px;" />
               </svg>
					<svg>
                  <image
							href="${pageContext.request.contextPath}/boardUpload/admin/함덕해수욕장1.jpg"
							style="height:200px;" />
               </svg>
				</div>
			</div>
