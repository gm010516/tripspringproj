			...
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-md-10 col-lg-8 col-xl-7">
					<div class="page-heading">
						<h1>admin travel spot</h1> 
						<span><h1 id="h">${travel.place}</h1></span>
			...
			<div align="center" class="card border-primary mb-3"
				...
				<table style="width: 90%">
					<tr>
						<td>
							<div align="right">
								<a class="a" href="insertTravelSpot.do"
									style="text-decoration: none;">글등록</a>&nbsp;&nbsp;&nbsp; <a
									class="a" href="updateTravelSpot.do?seq=${travel.seq}"
									style="text-decoration: none;">글수정</a>&nbsp;&nbsp;&nbsp; <a
									class="a" href="deleteTravelSpot.do?seq=${ travel.seq }"
									style="text-decoration: none;">글삭제</a>&nbsp;&nbsp;&nbsp; <a
									class="a" href="getTravelSpotList.do"
									style="text-decoration: none;">글목록</a> <br> <br>
							</div>
						</td>
					</tr>
										...
										<tr>
											<td colspan="2"><div class='file-input'>
													<input id="file2" type='file' name="uploadFile2"
														...
														for="file2" class='label b'>사진을 고르세요</label>
												</div></td>
										</tr>
										<tr>
											<td colspan="2"><div class='file-input'>
													<input id="file3" type='file' name="uploadFile3"
														...
														for="file3" class='label b'>사진을 고르세요</label>
												</div></td>
										</tr>
										<tr>
											<td colspan="2"><div class="file-input">
													<input id="file4" type='file' name="uploadFile4"
														...
														for="file4" class='label b'>사진을 고르세요</label>
												</div></td>
										</tr>
					...
					<c:forEach items="${replyList}" var="reply">
						...
						<table border="1" style="width: 60%; height: 100%;">
							<tr align="left">
									...
									<table style="height: 100%; margin: 15px;">
										...
										<tr>
											<td style="padding-left: 15px;">
												<!-- 관리자는 회원 댓글을 삭제할 수 있어야하고, 수정은 못하게 처리! --> <c:if
													test="${reply.writer == id}">
													<a href="updateReply.do?reseq=${reply.reseq}"
														style="text-decoration: none;" class="b">수정</a>&nbsp;&nbsp;&nbsp;
												</c:if> <a
												href="deleteReply.do?reseq=${reply.reseq}&seq=${reply.seq}"
												style="text-decoration: none;" class="b">삭제</a>
											</td>
										</tr>
								...
								<td
									style="padding: 10px; text-align: right; margin = auto; vertical-align: middle;">
									<div align="center">
										...
										<c:choose>
											<c:when
												...
												<span><img src="./boardUpload/user/${reply.image1}"
													height="100px" width="45%" border="0" align="middle"
										...
										<c:choose>
											<c:when test="${not empty reply.image2}">
												<span><img src="./boardUpload/user/${reply.image2}"
													height="100px" width="45%" border="0" style="padding: 2px;"></span>
										...
										<c:choose>
											<c:when test="${not empty reply.image3}">
												<span><img src="./boardUpload/user/${reply.image3}"
													height="100px" width="45%" border="0" style="padding: 2px;"
													onclick="window.open(this.src)"></span>
