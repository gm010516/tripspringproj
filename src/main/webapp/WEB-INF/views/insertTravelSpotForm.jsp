...
<title>TRIPSPOT_ADMIN_INSERT</title>
...
<script>
	function check() {
		var place = insertform.place.value;
		var address = insertform.address.value;
		var content = insertform.content.value;

		if (place.length == "") {
			alert("관광지를 입력하세요.");
			insertform.place.focus();
			return false;
		}
		if (address.length == "") {
			alert("주소를 입력하세요.");
			insertform.address.focus();
			return false;
		}
		if (content.length == "") {
			alert("내용을 입력하세요.");
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarColor03">
				<ul class="navbar-nav me-auto">
					...
					<li class="nav-item"><a class="nav-link" href="getTravelSpotList.do">TravelList</a></li>
	...
	<main class="mb-4">
		...
		<div class="container px-4 px-lg-5">
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="card border-primary mb-3" style="width: 900px;">
					<form id="insertform" name="insertform" action="insertTravelSpot.do" method="post"
						...
						<table width="800px" cellspacing="0" cellpadding="0"
							...
							<%-- <input type="hidden" name="getMEMBER_ID" value="${id}" /> --%>
							<tr>
								<td width="15%" class="b">관광지</td>
								<td class="form-item" align="left"><input type="text" name="place" style="padding-left: 15px; font-size: 16px;" class="b"/></td>
							</tr>
							...
							<tr>
								...
								<td align="left" class="form-item1" style="padding-right: 15px;"><textarea
										name="address" cols="85" rows="2" class="b" style="padding-left: 15px; font-size: 16px;"></textarea></td>
							</tr>
							...
							<tr class="b">
								<td width="15%" class="b">내&nbsp;&nbsp;&nbsp;용</td>
								<td align="left" class="form-item1" style="padding-right: 15px;"><textarea
										name="content" cols="85" rows="10" class="b" style="padding: 15px; font-size: 16px;"></textarea></td>
							</tr>
								...
								<td colspan="2">
									<div class='file-input'>
										<input type='file' id="file1" name="uploadFile1"
											...
											for="file1" class='label' class="b">image1</label>
									</div>
								</td>
							</tr>
							...
							<tr>
								<td colspan="2">
									<div class='file-input'>
										...
										<span class="btn btn-secondary disabled">Image Upload2</span> 
										<label class='label' for="file2" class="b">image2</label>
									</div>
								</td>
							</tr>
							...
							<tr class="b">
								...
								<input type="submit" value="등록" class="btn btn-secondary text-uppercase" />&nbsp;&nbsp;
								<span class="btn btn-secondary">
								<a href="getTravelSpotList.do" style="color: white; text-decoration: none;">취소</a>
								</span>
